...
set output "FIGURE/Performance.pdf"
plot GNUPLOT_NAMEFILE using 2:($1!=1 ? 1/0 : $3) title 'Our Pir algorithm - cache 1' with lines lt 1 lw 2, \
     GNUPLOT_NAMEFILE using 2:($1!=2 ? 1/0 : $3) title 'Our Pir algorithm - cache 2' with lines lt 2 lw 2, \
     GNUPLOT_NAMEFILE using 2:($1!=3 ? 1/0 : $3) title 'Our Pir algorithm - cache 3' with lines lt 3 lw 2, \
     GNUPLOT_NAMEFILE using 2:($1!=4 ? 1/0 : $3) title 'Our Pir algorithm - cache 4' with lines lt 4 lw 2, \
     GNUPLOT_NAMEFILE using 2:($1!=5 ? 1/0 : $3) title 'Our Pir algorithm - cache 5' with lines lt 5 lw 2, \
