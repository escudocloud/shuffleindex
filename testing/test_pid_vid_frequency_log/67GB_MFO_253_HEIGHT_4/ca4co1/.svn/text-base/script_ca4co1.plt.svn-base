...
NOMEFILE = " (cache element = 4, cover search = 1).log"
...
set output "./Pid_4_1_2.ps"
plot "./Pid_0.125_4_1_2.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_4_1_2.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_4_1_2.log" using 2 with lines ti "Profile 0.5"

set title "PIDs frequency analysis (Level 3)".NOMEFILE

#FREQUENZE DEI PID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 3

set output "./Pid_4_1_3.ps"
plot "./Pid_0.125_4_1_3.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_4_1_3.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_4_1_3.log" using 2 with lines ti "Profile 0.5"

set title "PIDs frequency analysis (Level 4)".NOMEFILE

#FREQUENZE DEI PID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 4

set output "./Pid_4_1_4.ps"
plot "./Pid_0.125_4_1_4.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_4_1_4.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_4_1_4.log" using 2 with lines ti "Profile 0.5"
...
set output "./Vid_4_1_2.ps"
plot "./Vid_0.125_4_1_2.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_4_1_2.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_4_1_2.log" using 2 with lines ti "Profile 0.5"

set title "VIDs frequency analysis (Level 3)".NOMEFILE

#FREQUENZE DEI vID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 3

set output "./Vid_4_1_3.ps"
plot "./Vid_0.125_4_1_3.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_4_1_3.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_4_1_3.log" using 2 with lines ti "Profile 0.5"

set title "VIDs frequency analysis (Level 4)".NOMEFILE

#FREQUENZE DEI vID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 4

set output "./Vid_4_1_4.ps"
plot "./Vid_0.125_4_1_4.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_4_1_4.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_4_1_4.log" using 2 with lines ti "Profile 0.5"
