...
NOMEFILE = " (cache element = 1, cover search = 4).log"
...
set output "./Pid_1_4_2.ps"
plot "./Pid_0.125_1_4_2.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_1_4_2.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_1_4_2.log" using 2 with lines ti "Profile 0.5"

set title "PIDs frequency analysis (Level 3)".NOMEFILE

#FREQUENZE DEI PID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 3

set output "./Pid_1_4_3.ps"
plot "./Pid_0.125_1_4_3.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_1_4_3.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_1_4_3.log" using 2 with lines ti "Profile 0.5"

set title "PIDs frequency analysis (Level 4)".NOMEFILE

#FREQUENZE DEI PID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 4

set output "./Pid_1_4_4.ps"
plot "./Pid_0.125_1_4_4.log" using 2 with lines ti "Profile 0.125", "./Pid_0.25_1_4_4.log" using 2 with lines ti "Profile 0.25", "./Pid_0.5_1_4_4.log" using 2 with lines ti "Profile 0.5"
...
set output "./Vid_1_4_2.ps"
plot "./Vid_0.125_1_4_2.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_1_4_2.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_1_4_2.log" using 2 with lines ti "Profile 0.5"

set title "VIDs frequency analysis (Level 3)".NOMEFILE

#FREQUENZE DEI vID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 3

set output "./Vid_1_4_3.ps"
plot "./Vid_0.125_1_4_3.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_1_4_3.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_1_4_3.log" using 2 with lines ti "Profile 0.5"

set title "VIDs frequency analysis (Level 4)".NOMEFILE

#FREQUENZE DEI vID A CONFRONTO NEI VARI PROFILI PER IL LIVELLO 4

set output "./Vid_1_4_4.ps"
plot "./Vid_0.125_1_4_4.log" using 2 with lines ti "Profile 0.125", "./Vid_0.25_1_4_4.log" using 2 with lines ti "Profile 0.25", "./Vid_0.5_1_4_4.log" using 2 with lines ti "Profile 0.5"
